...
if __name__ == '__main__':
    ...
    plotting_svm(predicted1, test_label1,"hcltech1_rbf.jpg",'r')
    plotting_svm(predicted2, test_label2,"hcltech2_rbf.jpg",'g')
    plotting_svm(predicted3, test_label3,"hcltech3_rbf.jpg",'b')
