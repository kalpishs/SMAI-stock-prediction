...
if __name__ == '__main__':
    fp1 = open("dataset/ongc_22_4.csv", 'a+')
    fp2= open("dataset/ongc_try_NN.csv",'r+')
    ...
    plotting_svm(predicted1, test_label1,"Plots/ongc/ongc1_22_apr_rbf.jpg",'r')
    plotting_svm(predicted2, test_label2,"Plots/ongc/ongc2_22_apr_rbf.jpg",'g')
    plotting_svm(predicted3, test_label3,"Plots/ongc/ongc3_22_apr_rbf.jpg",'b')
    plotting_svm(predicted4, test_label4,"Plots/ongc/ongc4_22_apr_rbf.jpg",'y')
    ...
    plotting_svm(predicted_NN_1, test_label1,"Plots/ongc/ongc1_22_apr_NN.jpg",'r')
    plotting_svm(predicted_NN_2, test_label2,"Plots/ongc/ongc2_22_apr_NN.jpg",'g')
    plotting_svm(predicted_NN_2, test_label3,"Plots/ongc/ongc3_22_apr_NN.jpg",'b')
    plotting_svm(predicted_NN_2, test_label4,"Plots/ongc/ongc4_22_apr_NN.jpg",'y')
