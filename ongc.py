...
if __name__ == '__main__':
    fp1 = open("dataset/ongc_20_4.csv", 'a+')
    ...
    plotting_svm(predicted1, test_label1,"Plots/ongc/ongc1_20_apr_rbf.jpg",'r')
    plotting_svm(predicted2, test_label2,"Plots/ongc/ongc2_20_apr_rbf.jpg",'g')
    plotting_svm(predicted3, test_label3,"Plots/ongc/ongc3_20_apr_rbf.jpg",'b')
    plotting_svm(predicted4, test_label4,"Plots/ongc/ongc4_20_apr_rbf.jpg",'y')
    ...
    plotting_svm(predicted_NN_1, test_label1,"Plots/ongc/ongc1_20_apr_NN.jpg",'r')
    plotting_svm(predicted_NN_2, test_label2,"Plots/ongc/ongc2_20_apr_NN.jpg",'g')
    plotting_svm(predicted_NN_2, test_label3,"Plots/ongc/ongc3_20_apr_NN.jpg",'b')
    plotting_svm(predicted_NN_2, test_label4,"Plots/ongc/ongc4_20_apr_NN.jpg",'y')
