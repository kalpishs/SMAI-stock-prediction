...
if __name__ == '__main__':
    fp1 = open("dataset/infy_19_4.csv", 'a+')
    fp2= open("dataset/infy_18_4.csv",'r+')
    ...
    plotting_svm(predicted1, test_label1, "infy1_rbf.jpg",'r')
    plotting_svm(predicted2, test_label2, "infy2_rbf.jpg",'g')
    plotting_svm(predicted3, test_label3, "infy3_rbf.jpg",'b')
