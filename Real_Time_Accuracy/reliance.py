...
def read_data(passing_for_url,fp):
    ...
    if passing_for_url==1:
        datasetname= urllib2.urlopen('http://chartapi.finance.yahoo.com/instrument/1.0/RELIANCE.NS/chartdata;type=quote;range=1d/csv')
    else:
        datasetname = fp
...
if __name__ == '__main__':
    fp1 = open("Real_Time_Dataset/reliance_19_4.csv", 'a+')
    fp2= open("Real_Time_Dataset/reliance_18_4.csv",'r+')
    ...
    print "-----------------------------------------------------------------------"
    plotting_accuracy(accuracy_score_list, "reliance_accuracy.jpg")
