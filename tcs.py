...
if __name__ == '__main__':
    fp1 = open("dataset/tcs_20_4.csv", 'a+')
    fp2= open("dataset/tcs_3days_NN.csv",'r+')
    ...
    plotting_svm(predicted1, test_label1,"Plots/tcs/tcs1_20_apr_rbf.jpg",'r')
    plotting_svm(predicted2, test_label2,"Plots/tcs/tcs2_20_apr_rbf.jpg",'g')
    plotting_svm(predicted3, test_label3,"Plots/tcs/tcs3_20_apr_rbf.jpg",'b')
    plotting_svm(predicted4, test_label4,"Plots/tcs/tcs4_20_apr_rbf.jpg",'y')
    ...
    plotting_svm(predicted_NN_1, test_label1,"Plots/tcs/tcs1_20_apr_NN.jpg",'r')
    plotting_svm(predicted_NN_2, test_label2,"Plots/tcs/tcs2_20_apr_NN.jpg",'g')
    plotting_svm(predicted_NN_2, test_label3,"Plots/tcs/tcs3_20_apr_NN.jpg",'b')
    plotting_svm(predicted_NN_2, test_label4,"Plots/tcs/tcs4_20_apr_NN.jpg",'y')
