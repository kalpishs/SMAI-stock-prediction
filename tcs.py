...
if __name__ == '__main__':
    ...
    plotting_svm(predicted1, test_label1, "tcs1_rbf.jpg",'r')
    plotting_svm(predicted2, test_label2, "tcs2_rbf.jpg",'g')
    plotting_svm(predicted3, test_label3, "tcs3_rbf.jpg",'b')
