...
if __name__ == '__main__':
    fp1 = open("dataset/reliance_19_4.csv", 'a+')
    fp2= open("dataset/reliance_15_4.csv",'r+')
    ...
    plotting_svm(predicted1, test_label1,"reliance1_rbf.jpg",'r')
    plotting_svm(predicted2, test_label2,"reliance2_rbf.jpg",'g')
    plotting_svm(predicted3, test_label3,"reliance3_rbf.jpg",'b')
