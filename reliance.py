...
def read_data(passing_for_url,fp):
    ...
    if passing_for_url==1:
        datasetname= urllib2.urlopen('http://chartapi.finance.yahoo.com/instrument/1.0/RELCAPITAL.NS/chartdata;type=quote;range=1d/csv')
    else:
        datasetname = fp
...
if __name__ == '__main__':
    fp1 = open("dataset/reliance_22_4.csv", 'a+')
    fp2= open("dataset/reliance_try_NN.csv",'r+')
    ...
    plotting_svm(predicted1, test_label1,"Plots/reliance/reliance1_22_apr_rbf.jpg",'r')
    plotting_svm(predicted2, test_label2,"Plots/reliance/reliance2_22_apr_rbf.jpg",'g')
    plotting_svm(predicted3, test_label3,"Plots/reliance/reliance3_22_apr_rbf.jpg",'b')
    plotting_svm(predicted4, test_label4,"Plots/reliance/reliance4_22_apr_rbf.jpg",'y')
    ...
    plotting_svm(predicted_NN_1, test_label1,"Plots/reliance/reliance1_22_apr_NN.jpg",'r')
    plotting_svm(predicted_NN_2, test_label2,"Plots/reliance/reliance2_22_apr_NN.jpg",'g')
    plotting_svm(predicted_NN_2, test_label3,"Plots/reliance/reliance3_22_apr_NN.jpg",'b')
    plotting_svm(predicted_NN_2, test_label4,"Plots/reliance/reliance4_22_apr_NN.jpg",'y')
